  ...
  return (
    <div className="p-4 bg-zinc-900 border-t border-zinc-800">
      <div className="max-w-4xl mx-auto relative">
        <form onSubmit={handleSubmit} className="relative flex items-end gap-2 bg-zinc-800/50 p-2 rounded-xl border border-zinc-700/50 focus-within:border-blue-500/50 focus-within:bg-zinc-800 focus-within:ring-1 focus-within:ring-blue-500/50 transition-all">
          <textarea
            ref={textareaRef}
            value={input}
          ...
          <div className="flex-shrink-0 pb-1 pr-1">
             <Button 
                ...
                className={isLoading ? "" : "rounded-lg w-10 h-10 p-0 flex items-center justify-center"}
             >
               {isLoading ? (
